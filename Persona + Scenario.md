...
Anne is resting over the weekend, and feels like she should look for mental health resources. She opens the website to search for resources, and immediately sees on the homescreen, a big button for mental health resources. She clicks on the button, and it takes her directly to a page with links, contacts, and resources. She is able to find appropriate help, and a clinic to call. She arranges a time next week to visit the clinic in person, and feels more calm knowing that she will be able to get help soon.
...
### Why Beth is using this product
 ...
 Beth is a a widowed woman who lives alone in New York. She is very technologically challenged and often does not know to how use the internet very well. She calls her grandchildren for assistance sometimes. She has been wanting to find a new doctor because she is concerned about some health issues. She wants to find one online that specifcally works on the issue that she is looking into.

### How Beth is using this product

She logs on to the website, and sees a find doctors button. When she clicks on the button, she is led to a page where a seaerch bar prompts her to type in her address and health condition. After filling it out, it compiles a list of doctors that specialize in the condition that she has. It also shows their locations on a mini map on the side. She is able to find a doctor, and locate his contact information. 
